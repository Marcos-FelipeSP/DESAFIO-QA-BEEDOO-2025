Feature: Módulo de Cursos - Listar, Cadastrar e Excluir
  ...
  Scenario: Cadastrar curso com dados válidos
    ...
    And preencho "nome do curso" com "Curso de Teste"
    And preencho "descrição do curso" com "Descrição válida"
    And preencho "Instrutor" com "Nome do instrutor"
    And preencho "Url da imagem da capa" com "Url válida"
    And preencho "data_inicio" com "2025-10-01"
    And preencho "data_fim" com "2025-10-10"
    And preencho "Número de vagas" com "Valor maior que zero"
    And preencho "Tipo do curso" com "Uma das escolhas"
    And submeto o formulário
    Then eu devo ver a confirmação de sucesso
  ...
  Scenario: Não permitir cadastrar curso com número de vagas negativo
    Given que eu estou na página principal
    When eu clico em "Cadastrar curso"
    And preencho "nome do curso" com "Curso Negativo"
  ...
  Scenario: Excluir curso com confirmação deve remover o curso
    ...
    Then o curso não deve aparecer mais na lista
